...
WSGI_APPLICATION = 'familypix.wsgi_webfaction.application'
...
INSTALLED_APPS = (
    ...
    'django.contrib.comments', # why do you need this???
...
LOGIN_REDIRECT_URL = "/uploadAlbum/"
